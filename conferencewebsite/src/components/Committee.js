...
export const Committee = () => {
  return (
    <div className='flex flex-col text-left px-36 py-10 gap-5'>
      <h1 className='text-gray-500 text-xl font-semibold'>DMLEFC Chairs</h1>
      ...
      <p className='text-gray-500'>
      Dr. Sudarshan Nandy, School Computer Science and Engineering (SCOPE), VIT University, Vellore, Contact: sudarshannandy@gmail.com
      </p>
      <h1 className='text-gray-500 text-xl font-semibold'>Publication Chair</h1>
      <p className='text-gray-500'>
      Dr. Varun G. Menon, IEEE Senior Member,  Professor at SCMS School of Engineering and Technology, Kerala, India. Contact: varungmenon46@gmail.com
      </p>
      <h1 className='text-gray-500 text-xl font-semibold'>Web Master</h1>
      <p className='text-gray-500'>
      Arunim Singhal, Indian Institute of Information Technology, Lucknow, India. (Email: arunimsinghal64@gmail.com)
      </p>
      <h1 className='text-gray-500 text-xl font-semibold'>Program Committee Members (tentative)</h1>
      <p className='text-gray-500'>
